...
export const NewTask = () => {
    ...
    const handleSubmit = () => {
        let task = {
            ...
            status : status,
            dueDate : JSON.stringify(selectedDate)
        }
        axios.post("http://ietilab7.azurewebsites.net/api/add-task?code=msTzvz9Z1OwuqMuuzj0ewjXT6o1J37fbl0CxEuie9KyC6cDEncGmkQ==" , task)
          .then(response => {
