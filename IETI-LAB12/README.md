...
gradle build
````
3. Back to repository root
4. Open the project with Android Studio.
5. Execute from Android Studio the project, if you don't know how to execute it read the information in this [Link](https://developer.android.com/training/basics/firstapp/running-app)
6. You will see the following screen

![app](img/img1.png)

7. Enter your credentials and log in
...
9. Access the following menu on the left side of the screen and you can logout

![app](img/img4.png)

10. You will return to the login screen
